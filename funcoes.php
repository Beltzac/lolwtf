...
Mais clareza em suas chamadas

Com o HD Voice* sua voz pode ser ouvida nitidamente sem interferências. Chamadas de lugares barulhentos não são mais um problema. O recurso de cancelamento de ruído filtra os sons de fundo. A pessoa com quem você está falando ouvirá sua voz claramente, como se vocês estivessem um ao lado do outro.
*A funcionalidade HD Voice está sujeita à operadora.

Walkman

Mude seu jeito de ouvir música. Com o aplicativo Walkman do seu Xperie E Dual é possível criar lista de reprodução com grande facilidade, sem perca de tempo. Aumente o volume com o aprimoramento de áudio xLoud e veja a mixagem do som com o equalizador gráfico.

Android 4.0

Desfrute deste sistema operacional renovado, que realizará as atualizações dos seus aplicativos em seu celular com mais rapidez e tempo de resposta mais ágil. Além disso, há um melhor gerenciamento da bateria.
E ainda conta com a ferramenta Google Now, que auxilia o usuário durante as buscas. Que identifica e registra as pesquisas mais frequentes.

O Xperia E Dual é lançado no Android 4.0 (Ice Cream Sandwich) e será atualizado para o Android 4.1 (Jelly Bean).
...
o Optimus L5 da LG é Dual Chip. Com essa facilidade você poderá ter duas linhas em um só aparelho celular.

Design Diferenciado
O LG Optimus L5 tem design em todos os detalhes. Possui uma tela touchscreen de 4 polegadas, que facilita a visualização de e-mails, fotos e vídeos.

Internet
Você pode acessar a rede por maneiras diferentes: via Wi-Fi, em que seu aparelho detecta redes sem fio disponíveis, a tecnologia 3G e Android 4.0. Com ele é possível conectar-se com milhares aplicativos disponíveis e diversos serviços como YouTube, Gmail, Google Maps, Navegação GPS.
...
Com uma câmera de 13 megapíxels, você tira fotos em alta resolução e com flash. Sua memória ainda pode ser estendida até 32GB, dessa forma é armazenado suas músicas, fotos e ainda compartilhar com os seus amigos via Bluetooth.
Além de um aparelho de comunicação, o Xperia ZQ ainda te ajuda a se localizar com o GPS e vem com a tecnologia NFC.

Processador Quad-Core
O Xperia ZQ possui um processador Quad-Core de 1.5GHz, deixando mais rápido as execuções realizadas no aparelho e melhorando seu desempenho e permite executar mais rápido várias tarefas ao mesmo tempo, tais como: Carregar depressa páginas da web, grande rapidez de reação, uma interface de utilizador mais simples e jogos de elevado desempenho. 

Tecnologia NFC
A NFC - Near Field Communication - é uma tecnologia que permite a troca de informações entre dispositivos sem a necessidade de cabos ou fios (wireless), sendo necessária apenas uma aproximação física.
Um dispositivo com um chip NFC pode funcionar como um documento de identidade ou ser usado para fazer um pagamento.

4G, Wi-Fi e Android 4.1
Um dos pontos de destaque do Sony Xperia ZQ é sua conectividade com a internet. Você pode acessar a rede por maneiras diferentes: via Wi-Fi, em que seu aparelho detecta redes sem fio disponíveis, tecnologia 4G e Android 4.1 já instalado no aparelho.

Memória Interna
O Xperia ZQ possui uma super memória interna de 16GB, perfeita para ser armazenado músicas, vídeos, jogos, fotos e vários outros arquivos. Com ele você desfruta de um excelente espaço, podendo ser expandido com um cartão Micro SD até 32GB. 
...
Design
O L9 da LG tem design em todos os detalhes. Possui uma tela Touchscreen de 4.7, que facilita a visualização de e-mails, fotos e vídeos.

Memória Interna
O L9 possui uma super memória interna de 4GB, perfeita para ser armazenado músicas, vídeos, fotos e vários outros arquivos. Com ele você desfruta de um excelente espaço, podendo ser expandido com um cartão Micro SD até 32GB. 

Processador Dual Core
O L9 possui um processador Dual Core de 1GHz, deixando mais rápido as execuções realizadas no aparelho e melhorando seu desempenho.

Fotos e Vídeos
Registre seus momentos com excelente qualidade de imagem com a câmera de 5.0 megapíxels e flash. Com ela você vai tirar belíssimas fotos e grava vídeos, ou ainda posta o registro em suas redes sociais.
...
Este aparelho possui Tela Amoled de 4 polegadas, vídeos em HD, Câmera de 5 megapíxels, Android 2.3 e Internet 3G de alta velocidade. 
Além disso, este Smartphone possui Processador Dual Core tendo resposta ultra-rápida para o desempenho do seu aparelho, permitindo executar muito rapidamente várias tarefas simultaneamente, tais como: Carregar depressa páginas da web, grande rapidez de reação, uma interface de utilizador mais simples e jogos de elevado desempenho. 

Câmera
Registre seus momentos com excelente qualidade de imagem com a câmera de 5 megapíxels e Flash LED. Com ela você vai tirar belíssimas fotos e gravar vídeos em HD, ou ainda postar o registro em suas redes sociais.

Processador
O Samsung Galaxy S II possui um processador Dual Core, deixando mais rápido as execuções realizadas no aparelho e melhorando seu desempenho.
Com um processador Dual Core, é possível tornar a navegação na internet muito mais rápida e melhora o desenvolvimento dos seus jogos com gráficos excelentes.

Fique conectado
Um dos pontos de destaque do Galaxy S II é sua conectividade com a internet. Você pode acessar a rede por maneiras diferentes: via Wi-Fi, em que seu aparelho detecta redes sem fio disponíveis e a tecnologia 3G.
